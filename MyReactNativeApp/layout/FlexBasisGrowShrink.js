...
export const FlexBasisGrowShrink = () => {
    ...
    <View style={[styles.row, { flexDirection: 'column' }]}>
        ...
        <TextInput
            ...
            onChangeText={fB =>
                setStyle(value => ({
                    ...value,
                    flexBasis: isNaN(parseInt(fB, 10)) ? 0 : parseInt(fB, 10),
                }))
            }
        />
        ...
        <TextInput
            ...
            onChangeText={fS =>
                setStyle(value => ({
                    ...value,
                    flexShrink: isNaN(parseInt(fS, 10)) ? 0 : parseInt(fS, 10),
                }))
            }
        />
        ...
        <TextInput
            ...
            onChangeText={fG =>
                setStyle(value => ({
                    ...value,
                    flexGrow: isNaN(parseInt(fG, 10)) ? 0 : parseInt(fG, 10),
                }))
            }
        />
    </View>
